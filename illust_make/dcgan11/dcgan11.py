    ...
    def save_imgs(self, iteration, check_noise, r, c):
        ...
        for i in range(r):
            for j in range(c):
                ...
                axs[i, j].axis('off')
                cnt += 1
        fig.savefig('gen_imgs/_%04d.png' % (iteration//1000))
...
dcgan.train(iterations=400001, batch_size=48, save_interval=1000, model_interval=5000,
